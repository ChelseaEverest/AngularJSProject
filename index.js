...
app.use(express.static(path.join(__dirname, 'dist/se3316-ceveres4-lab5')));//catch all other routes to return the index file
...
app.get('*', (req,res) => {
    res.sendFile(path.join(__dirname,'dist/se3316-ceveres4-lab5/index.html'));
});
